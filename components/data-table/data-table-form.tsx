...
import { TDataTableDataValidation } from '@/components/data-table/@types';
   ...
   return (
      <Form {...form}>
         <form className={'space-y-2'} onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Button onClick={(event) => event.stopPropagation()} className={'w-full'} type="submit">
               Submit
            </Button>
         </form>
      </Form>
               ...
               <SelectGroup>
                  ...
                  {!_.isEmpty(data) &&
                     data?.map(({ value, children }, index) => (
                        <SelectItem key={value.concat('--', index.toString())} value={value}>
                           {children}
                        </SelectItem>
                     ))}
               </SelectGroup>
            ...
            render={() => (
               <FormItem>
                  <div className="mb-2">
                     ...
                     {!_.isEmpty(description) && <FormDescription>{description}</FormDescription>}
                  </div>
                  {(data || []).map((item) => (
                     <FormField
                        key={item.value}
                        ...
                        render={({ field }) => {
                           return (
                              ...
                              >
                                 ...
                                 <FormLabel
                                    className={componentCssProps?.child || 'text-sm font-normal'}
                                 >
                                    {item.children}
                                 </FormLabel>
                              </FormItem>
